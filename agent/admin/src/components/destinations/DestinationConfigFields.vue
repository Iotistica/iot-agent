...
<template>
  ...
  <!-- No-op demo destination — no configuration needed -->
  <template v-else-if="type === 'noop'">
    <a-alert type="info" show-icon style="margin-bottom: 16px">
      <template #message>Demo / No-op destination</template>
      <template #description>Payloads are accepted and silently discarded. Use this to demo the publish pipeline without sending data anywhere.</template>
    </a-alert>
  </template>
